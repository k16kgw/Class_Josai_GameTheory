...
\question{第5問：サポートを仮定した混合戦略の確認}{6}
次のゲームを考える．
\[
\begin{array}{c|ccc}
...
\begin{enumerate}[label=(\arabic*)]
  ...
  \[
    5-\frac{5}{8}=\frac{35}{8}
  \]
  である．一方，$L,C$ の期待利得は
  \[
    4+2\cdot\frac{5}{8}=\frac{21}{4}
  \]
  である．$\frac{35}{8}<\frac{21}{4}$ なので，$R$ に逸脱すると利得は真に低くなる．
